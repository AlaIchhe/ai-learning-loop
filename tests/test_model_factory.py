"""socratic_loop.infra.model.get_chat_model 新增 api_key 参数测试。"""
...
class TestGetChatModelApiKeyParam:
    ...
    def test_explicit_api_key_passed_to_chatai(self):
        ...
        with (
            ...
            patch("socratic_loop.infra.model.ChatOpenAI") as mock_cls,
...
class TestGetChatModelForProfile:
    def test_helper_creates_model_from_profile(self):
        from socratic_loop.infra.model import get_chat_model_for_profile
